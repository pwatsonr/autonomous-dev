...
describe('RoutingEngine', () => {
  ...
  test('advanced mode missing type falls back to default_target', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining('No advanced routing config'));
  ...
  test('unknown primary target falls back to default_target', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith(expect.stringContaining('not a known target'));
