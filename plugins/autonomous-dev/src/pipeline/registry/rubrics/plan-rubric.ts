  ...
  categories: [
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Some tasks need further decomposition or merging' },
        {
          min: 70,
          max: 89,
          description: 'Tasks are well-sized for single implementation sessions',
        },
    ...
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'Dependencies are missing, circular, or contradictory' },
        {
          min: 40,
          max: 69,
          description: 'Some implicit dependencies not captured or ordering issues',
        },
    ...
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Key risks identified with viable contingency plans' },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive risk register with prioritized contingencies',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'No acceptance criteria defined for tasks' },
        {
          min: 40,
          max: 69,
          description: 'Some tasks lack acceptance criteria or criteria are vague',
        },
        { min: 70, max: 89, description: 'Most tasks have testable acceptance criteria' },
        {
          min: 90,
          max: 100,
          description: 'All tasks have precise, verifiable acceptance criteria',
        },
      ],
    },
  ],
