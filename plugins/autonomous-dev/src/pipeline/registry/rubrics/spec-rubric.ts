    ...
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Test cases defined for all major tasks' },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive test matrix with edge cases and error paths',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'API contracts are well-defined with types and examples' },
        {
          min: 90,
          max: 100,
          description: 'Full contract definitions with validation rules and edge cases',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Error scenarios documented with expected behaviors' },
        {
          min: 90,
          max: 100,
          description: 'Complete error catalog with recovery and fallback behaviors',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'No implementation guidance provided' },
        {
          min: 40,
          max: 69,
          description: 'Some guidance but significant design decisions left to developer',
        },
