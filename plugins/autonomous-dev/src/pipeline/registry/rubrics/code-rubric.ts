  ...
  categories: [
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Correct for all specified scenarios' },
        {
          min: 90,
          max: 100,
          description: 'Provably correct with defensive handling and invariant checks',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Happy path covered but edge cases missing' },
        {
          min: 70,
          max: 89,
          description: 'Good coverage of specified behaviors and common edge cases',
        },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive coverage with edge cases, error paths, and property tests',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        {
          min: 0,
          max: 39,
          description: 'Unreadable, violates project standards, or unmaintainable',
        },
        { min: 40, max: 69, description: 'Mostly readable with some style issues or code smells' },
        {
          min: 70,
          max: 89,
          description: 'Clean, well-structured code that follows project standards',
        },
        {
          min: 90,
          max: 100,
          description: 'Exemplary code with clear abstractions and documentation',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'Significant deviations from specification' },
        {
          min: 40,
          max: 69,
          description: 'Some spec items not implemented or implemented incorrectly',
        },
        { min: 70, max: 89, description: 'All spec items implemented correctly' },
        {
          min: 90,
          max: 100,
          description: 'Exact spec compliance with documented rationale for any deviations',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Basic error handling but missing edge cases or logging' },
        {
          min: 70,
          max: 89,
          description: 'Proper error handling with logging and user-facing messages',
        },
        {
          min: 90,
          max: 100,
          description: 'Robust error handling with recovery, retry, and observability',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'No documentation or comments' },
        {
          min: 40,
          max: 69,
          description: 'Some documentation but key functions or modules undocumented',
        },
        {
          min: 70,
          max: 89,
          description: 'Public APIs documented with JSDoc and key logic commented',
        },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive documentation with usage examples and design notes',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        {
          min: 0,
          max: 39,
          description: 'Severe performance issues or O(n^2+) where O(n) is possible',
        },
        {
          min: 40,
          max: 69,
          description: 'Acceptable performance but optimization opportunities missed',
        },
        {
          min: 70,
          max: 89,
          description: 'Efficient implementation meeting performance requirements',
        },
        {
          min: 90,
          max: 100,
          description: 'Optimized with benchmarks and performance documentation',
        },
      ],
    },
  ],
