      ...
      scoringGuide: [
        {
          min: 0,
          max: 39,
          description: 'Requirements are vague, contradictory, or unintelligible',
        },
        ...
        { min: 70, max: 89, description: 'Requirements are clear and understandable' },
        {
          min: 90,
          max: 100,
          description: 'Crystal clear with precise, measurable language throughout',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'Requirements are unrealistic or technically impossible' },
        {
          min: 40,
          max: 69,
          description: 'Some requirements may be difficult to achieve within constraints',
        },
        { min: 70, max: 89, description: 'Requirements are achievable with known approaches' },
        {
          min: 90,
          max: 100,
          description: 'Clear implementation path with proven patterns and technologies',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'User value clearly articulated for most requirements' },
        {
          min: 90,
          max: 100,
          description: 'Every requirement tied to specific user outcomes with evidence',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Scope partially defined with significant gaps' },
        {
          min: 70,
          max: 89,
          description: 'Clear in-scope and out-of-scope sections with rationale',
        },
        {
          min: 90,
          max: 100,
          description: 'Precise scope with explicit exclusions and future considerations',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'No acceptance criteria defined' },
        {
          min: 40,
          max: 69,
          description: 'Some requirements lack acceptance criteria or criteria are vague',
        },
        { min: 70, max: 89, description: 'Most requirements have testable acceptance criteria' },
        {
          min: 90,
          max: 100,
          description: 'All requirements have precise, measurable acceptance criteria',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Some risks identified but mitigations incomplete' },
        {
          min: 70,
          max: 89,
          description: 'Major risks identified with viable mitigation strategies',
        },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive risk matrix with prioritized mitigations',
        },
      ],
    },
  ],
