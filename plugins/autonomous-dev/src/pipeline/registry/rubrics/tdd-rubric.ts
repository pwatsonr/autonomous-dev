  ...
  categories: [
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'All major components documented with adequate detail' },
        {
          min: 90,
          max: 100,
          description: 'Exhaustive coverage of all technical decisions and rationale',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Technically sound with well-justified decisions' },
        {
          min: 90,
          max: 100,
          description: 'Demonstrably correct with references to proven patterns',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        {
          min: 0,
          max: 39,
          description: 'Architecture is monolithic, tightly coupled, or unscalable',
        },
        { min: 40, max: 69, description: 'Architecture has some coupling or scalability concerns' },
        {
          min: 70,
          max: 89,
          description: 'Well-structured architecture with clear separation of concerns',
        },
        {
          min: 90,
          max: 100,
          description: 'Exemplary architecture with extensibility and evolution paths',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'APIs are consistent, well-typed, and documented' },
        {
          min: 90,
          max: 100,
          description: 'APIs follow industry best practices with versioning and discoverability',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 70, max: 89, description: 'Comprehensive error handling with recovery strategies' },
        {
          min: 90,
          max: 100,
          description: 'Full error taxonomy with graceful degradation and observability',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        { min: 0, max: 39, description: 'No testing strategy defined' },
        {
          min: 40,
          max: 69,
          description: 'Basic testing approach but missing layers or edge cases',
        },
        { min: 70, max: 89, description: 'Multi-layer testing strategy with clear boundaries' },
        {
          min: 90,
          max: 100,
          description: 'Comprehensive test pyramid with performance and integration plans',
        },
      ],
    },
    {
      ...
      scoringGuide: [
        ...
        { min: 40, max: 69, description: 'Some security concerns noted but not fully addressed' },
        {
          min: 70,
          max: 89,
          description: 'Key security threats identified with mitigations in design',
        },
        {
          min: 90,
          max: 100,
          description: 'Threat model with defense-in-depth and security review plan',
        },
      ],
    },
  ],
