  ...
  categories: [
    {
      ...
      weight: 25,
      description: 'Implementation matches the specification exactly with no deviations.',
      min_threshold: 80,
      calibration: {
        score_0: 'Implementation bears no resemblance to the specification.',
        score_50:
    ...
    },
    {
      ...
      min_threshold: 70,
      calibration: {
        score_0: 'No tests written, or tests do not execute.',
        score_50: 'Happy path tests pass but edge cases and error paths are untested.',
        score_100:
    ...
    },
    {
      ...
      min_threshold: 60,
      calibration: {
        score_0: 'Code is unreadable, violates all project standards, or is unmaintainable.',
        score_50:
    ...
    },
    {
      ...
      min_threshold: 50,
      calibration: {
        score_0: 'No documentation or comments of any kind.',
        score_50: 'Some functions documented but public APIs or complex logic lack comments.',
        score_100:
    ...
    },
    {
      ...
      calibration: {
        ...
        score_50: 'Acceptable performance but obvious optimization opportunities are missed.',
        score_100:
    ...
    },
    {
      ...
      name: 'Security',
      weight: 10,
      description: 'Code follows security best practices with no known vulnerabilities.',
      min_threshold: 60,
      calibration: {
        score_0:
          'Code has critical security vulnerabilities (injection, exposed secrets, no auth).',
        score_50: 'Basic security measures in place but some best practices are not followed.',
        score_100:
    ...
    },
    {
      ...
      weight: 10,
      description: 'Code is easy to understand, modify, and extend by other developers.',
      min_threshold: 50,
      calibration: {
        score_0: 'Code is a tangled mess that no one else could understand or modify.',
        score_50:
