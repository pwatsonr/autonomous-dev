# TDD-033: Setup-Wizard Phase Modules (Phases 8 & 11-16)
...
| Wizard step-by-step that invokes chains       | TDD-033 (this)              | Owns the operator-facing flow.                   |
| Chain output quality eval sets                | PRD-015 / TDD-025           | Eval the chain itself.                           |
| Wizard-step completion eval sets              | TDD-033 (this)              | Eval the wizard correctly invokes the chain.     |
