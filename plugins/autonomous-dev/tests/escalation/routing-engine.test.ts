...
import type { EscalationConfig, EscalationType, RoutingTarget } from '../../src/escalation/types';
...
function makeDefaultConfig(overrides: Partial<EscalationConfig> = {}): EscalationConfig {
  return {
    routing: {
      mode: 'default',
...
describe('RoutingEngine', () => {
  ...
  test('no knownTargetIds means all targets are assumed valid', () => {
    ...
    expect(warnSpy).not.toHaveBeenCalledWith(expect.stringContaining('is not a known target'));
