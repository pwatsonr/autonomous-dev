...
import type { AuditTrail, PendingChange } from '../../src/trust/trust-change-manager';
...
describe('TrustChangeManager', () => {
  ...
  test('emits trust_upgrade_confirmed on confirmUpgrade', () => {
    ...
    const confirmedEvents = audit.events.filter((e) => e.event_type === 'trust_upgrade_confirmed');
  ...
  test('emits trust_upgrade_rejected on rejectUpgrade', () => {
    ...
    const rejectedEvents = audit.events.filter((e) => e.event_type === 'trust_upgrade_rejected');
  ...
  test('confirmUpgrade throws when change is not awaiting confirmation', () => {
    ...
    expect(() => manager.confirmUpgrade('req-1')).toThrow('not awaiting confirmation');
  });
  ...
  test('rejectUpgrade throws when change is not awaiting confirmation', () => {
    ...
    expect(() => manager.rejectUpgrade('req-1')).toThrow('not awaiting confirmation');
  });
