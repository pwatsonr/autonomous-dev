...
async function seedAppendixAData(rootDir: string): Promise<void> {
  ...
  const specs: Array<{
    ...
    // P0: 1 (promoted)
    {
      id: 'OBS-20260406-090000-a001',
      service: 'api-gateway',
      severity: 'P0',
      type: 'error',
      triage_decision: 'promote',
      triage_at: '2026-04-06T10:00:00Z',
      effectiveness: 'improved',
      oscillation_warning: false,
      tokens: 42000,
      run: 'RUN-20260406-090000',
    },
    // P1: 3 (1 promoted, 1 dismissed, 1 investigating)
    {
      id: 'OBS-20260406-100000-a002',
      service: 'api-gateway',
      severity: 'P1',
      type: 'error',
      triage_decision: 'promote',
      triage_at: '2026-04-06T11:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 38000,
      run: 'RUN-20260406-100000',
    },
    {
      id: 'OBS-20260407-080000-a003',
      service: 'payment-svc',
      severity: 'P1',
      type: 'error',
      triage_decision: 'dismiss',
      triage_at: '2026-04-07T09:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 35000,
      run: 'RUN-20260407-080000',
    },
    {
      id: 'OBS-20260408-060000-a004',
      service: 'auth-svc',
      severity: 'P1',
      type: 'anomaly',
      triage_decision: 'investigate',
      triage_at: '2026-04-08T07:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 40000,
      run: 'RUN-20260408-060000',
    },
    // P2: 7 (2 promoted, 3 dismissed, 1 deferred, 1 pending)
    {
      id: 'OBS-20260406-110000-a005',
      service: 'api-gateway',
      severity: 'P2',
      type: 'error',
      triage_decision: 'promote',
      triage_at: '2026-04-06T14:00:00Z',
      effectiveness: null,
      oscillation_warning: true,
      error_class: 'ConnPool',
      tokens: 30000,
      run: 'RUN-20260406-110000',
    },
    {
      id: 'OBS-20260406-120000-a006',
      service: 'search-svc',
      severity: 'P2',
      type: 'error',
      triage_decision: 'promote',
      triage_at: '2026-04-06T15:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 28000,
      run: 'RUN-20260406-120000',
    },
    {
      id: 'OBS-20260407-090000-a007',
      service: 'payment-svc',
      severity: 'P2',
      type: 'anomaly',
      triage_decision: 'dismiss',
      triage_at: '2026-04-07T10:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 25000,
      run: 'RUN-20260407-090000',
    },
    {
      id: 'OBS-20260407-100000-a008',
      service: 'search-svc',
      severity: 'P2',
      type: 'error',
      triage_decision: 'dismiss',
      triage_at: '2026-04-07T11:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 27000,
      run: 'RUN-20260407-090000',
    ...
    {
      id: 'OBS-20260407-110000-a009',
      service: 'auth-svc',
      severity: 'P2',
      type: 'trend',
      triage_decision: 'dismiss',
      triage_at: '2026-04-07T14:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 22000,
      run: 'RUN-20260407-110000',
    },
    {
      id: 'OBS-20260408-070000-a010',
      service: 'api-gateway',
      severity: 'P2',
      type: 'error',
      triage_decision: 'defer',
      triage_at: '2026-04-08T08:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 26000,
      run: 'RUN-20260408-070000',
    },
    {
      id: 'OBS-20260408-080000-a011',
      service: 'payment-svc',
      severity: 'P2',
      type: 'error',
      ...
      oscillation_warning: false,
      tokens: 24000,
      run: 'RUN-20260408-080000',
    },
    // P3: 3 (1 deferred, 1 dismissed, 1 pending)
    {
      id: 'OBS-20260406-130000-a012',
      service: 'cdn-svc',
      severity: 'P3',
      type: 'trend',
      triage_decision: 'defer',
      triage_at: '2026-04-06T16:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 18000,
      run: 'RUN-20260406-130000',
    },
    {
      id: 'OBS-20260407-120000-a013',
      service: 'cdn-svc',
      severity: 'P3',
      type: 'anomaly',
      triage_decision: 'dismiss',
      triage_at: '2026-04-07T15:00:00Z',
      effectiveness: null,
      oscillation_warning: false,
      tokens: 16000,
      run: 'RUN-20260407-120000',
    },
    {
      id: 'OBS-20260408-090000-a014',
      service: 'search-svc',
      severity: 'P3',
      type: 'trend',
      triage_decision: null,
  ...
  for (const spec of specs) {
    const lines: string[] = [
      ...
      `timestamp: "${spec.id
        ...
        .replace(
          /(\d{4})(\d{2})(\d{2})/,
          '$1-$2-$3',
        )}T${spec.id.substring(13, 15)}:${spec.id.substring(15, 17)}:${spec.id.substring(17, 19)}Z"`,
    ...
    await fs.writeFile(path.join(obsDir, `${spec.id}.md`), lines.join('\n'), 'utf-8');
  }
}
